...
{
    public partial class StudentClearanceSlip : DevExpress.XtraReports.UI.XtraReport
    {
        public StudentClearanceSlip()
        {
            InitializeComponent();
        }
        ...
        private void ApplyStatusStyle(XRLabel statusLabel)
        {
            ...
            {
                statusLabel.ForeColor = Color.FromArgb(8, 80, 65);
            }
            else
            {
                statusLabel.ForeColor = Color.FromArgb(100, 40, 40);
            }
        }
